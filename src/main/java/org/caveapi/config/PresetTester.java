...
public class PresetTester {
    ...
    private void testConditions(ConditionSettings s, String path) {
        ...
        this.testBiomeList(s.biomes2, s.blacklistBiomes2, path);
        this.testBiomeList(s.biomes3, s.blacklistBiomes3, path);
        this.testBiomeList(s.biomes4, s.blacklistBiomes4, path);
