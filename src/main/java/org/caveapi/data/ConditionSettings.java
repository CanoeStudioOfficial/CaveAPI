...
public class ConditionSettings {
    ...
    /** Whether the biomes list should be treated as a blacklist. */
    @Default boolean blacklistBiomes2 = false;
    /** If not 0, this dimension's biome provider is checked instead of the current dimension. */
    @Default Integer proxyDimension2 = 0;
    /** A list of biomes in which this feature can spawn. */
    @Default List<Biome> biomes2 = Collections.emptyList();

    /** Whether the biomes list should be treated as a blacklist. */
    @Default boolean blacklistBiomes3 = false;
    /** If not 0, this dimension's biome provider is checked instead of the current dimension. */
    @Default Integer proxyDimension3 = 0;
    /** A list of biomes in which this feature can spawn. */
    @Default List<Biome> biomes3 = Collections.emptyList();

    /** Whether the biomes list should be treated as a blacklist. */
    @Default boolean blacklistBiomes4 = false;
    /** If not 0, this dimension's biome provider is checked instead of the current dimension. */
    @Default Integer proxyDimension4 = 0;
    /** A list of biomes in which this feature can spawn. */
    @Default List<Biome> biomes4 = Collections.emptyList();
    ...
    private static ConditionSettings copyInto(JsonObject json, ConditionSettingsBuilder builder) {
        return new HjsonMapper(json)
            ...
            .mapBool(Fields.blacklistBiomes2, builder::blacklistBiomes2)
            .mapInt(Fields.proxyDimension2, builder::proxyDimension2)
            .mapBiomes(Fields.biomes2, builder::biomes2)
            .mapBool(Fields.blacklistBiomes3, builder::blacklistBiomes3)
            .mapInt(Fields.proxyDimension3, builder::proxyDimension3)
            .mapBiomes(Fields.biomes3, builder::biomes3)
            .mapBool(Fields.blacklistBiomes4, builder::blacklistBiomes4)
            .mapInt(Fields.proxyDimension4, builder::proxyDimension4)
            .mapBiomes(Fields.biomes4, builder::biomes4)
