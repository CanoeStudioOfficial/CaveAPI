package caveapi.cavegenerator.commands;

import caveapi.cavegenerator.CaveInit;
import caveapi.cavegenerator.Main;
import caveapi.cavegenerator.config.*;
import com.personthecat.cavegenerator.config.*;
import caveapi.cavegenerator.noise.CachedNoiseHelper;
import caveapi.cavegenerator.util.Calculator;
import caveapi.cavegenerator.util.CaveLinter;
import caveapi.cavegenerator.util.HjsonTools;
import caveapi.cavegenerator.world.feature.StructureSpawner;
...
import static caveapi.cavegenerator.io.SafeFileIO.backup;
import static caveapi.cavegenerator.io.SafeFileIO.ensureDirExists;
import static caveapi.cavegenerator.io.SafeFileIO.rename;
import static caveapi.cavegenerator.io.SafeFileIO.copy;
import static caveapi.cavegenerator.io.SafeFileIO.fileExists;
import static caveapi.cavegenerator.io.SafeFileIO.listFiles;
import static caveapi.cavegenerator.util.CommonMethods.empty;
import static caveapi.cavegenerator.util.CommonMethods.extension;
import static caveapi.cavegenerator.util.CommonMethods.f;
import static caveapi.cavegenerator.util.CommonMethods.full;
import static caveapi.cavegenerator.util.CommonMethods.noExtension;
import static caveapi.cavegenerator.util.CommonMethods.nullable;
import static caveapi.cavegenerator.util.CommonMethods.runEx;
import static caveapi.cavegenerator.util.CommonMethods.runExF;
import static caveapi.cavegenerator.util.CommonMethods.toArray;
import static caveapi.cavegenerator.util.HjsonTools.getBool;
import static caveapi.cavegenerator.util.HjsonTools.FORMATTER;
import static caveapi.cavegenerator.util.HjsonTools.writeJson;
